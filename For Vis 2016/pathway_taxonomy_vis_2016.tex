...
Multivariate network visualization is a highly active field of visualization, in which the life sciences in general are frequent application domain, see \cite{kerren2014multivariate} for a recent state of the art survey. 
...
Many visualization applications use the more traditional approach of arrowheads to indicate edge directions, however work by Holten and van Wijk~\cite{Holten2009} shows that in many cases tapered edges perform more effectively in conveying edge direction.
