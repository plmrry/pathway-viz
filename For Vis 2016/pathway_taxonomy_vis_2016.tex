...
\paragraph{\textbf{Existing Approaches and Techniques}}
...
A modification can take many forms, such as \textit{ubiquitination} or \textit{phosphorylation}, and the \texit{site} at which these modifications occur can also be specified.
Changes in gene expression are directional -- one compound can either \texit{increase} or \texit{decrease} the activity of another.
A translocation event will typically specify \texit{from} and \texit{to} locations.
...
\paragraph{\textbf{Existing Approaches and Techniques}} \hl{to-do}
