...
\ \\ \
\noindent{\textbf{(A2, A3)} \underline{Identify Provenance and Uncertainty}}
...
\ \\ \
\noindent{\textbf{(A4)} \underline{Compare Data Sets}}
...
The \textit{RenoDoI} plugin uses superposition as a comparison technique, allowing multiple networks to be visualized in a single image. Bounding isocountours are used to distinguish graphs differences, and to clearly indicate where the graphs overlap.
...
\ \\ \
\noindent{\textbf{(R1)} \underline{Identify Multivariate Relationships}}
...
\subsection*{Comparison Tasks}
\ \\ \
\noindent{\textbf{(C1, C2)} \underline{Compare Data and Integrate Knowledge}}
%\subsubsection*{Comparison and Contextualization Tasks}
...
\ \\ \
\noindent{\textbf{(M1, M2)} \underline{Annotate Data and Personalize Pathways}}
\paragraph*{Description}
...
\ \\ \
\noindent{\textbf{(M3)} \underline{Integrate Knowledge}}
