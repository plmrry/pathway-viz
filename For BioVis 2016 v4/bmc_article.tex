...
Hadlak et al.~\cite{hadlak2015survey} provide a survey of faceted graph visualization techniques, categorizing visualizations based on how the data is faceted, e.g. by attribute, time, or space.
