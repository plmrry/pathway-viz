...
\ \\ \
\noindent{\textbf{(A1)} \underline{Identifying Multivariate Attributes}}
...
\ \\ \
\noindent{\textbf{(A2, A3)} \underline{Identifying Provenance and Uncertainty}}
...
\ \\ \
\noindent{\textbf{(A2, A3)} \underline{Comparing Datasets}}
...
\ \\ \
\noindent{\textbf{(R1)} \underline{Identifying Relationship Attributes}}
...
\ \\ \
\noindent{\textbf{(R2)} \underline{Identifying Directed Relationships}}
...
\ \\ \
\noindent{\textbf{(R3)} \underline{Identifying Grouping Relationships}}
...
\ \\ \
\noindent{\textbf{(R4, R5)} \underline{Identifying Causality and Cascading Effects}}
...
\ \\ \
\noindent{\textbf{(D1, D2)} \underline{Annotate Data and Personalize Pathways}}
\paragraph*{Description}
