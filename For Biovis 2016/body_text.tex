...
We also review visual representations of pathway data in the context of our, along with a brief discussion of existing tools which implement those visual representations.
...
The most prominent data format that supporting this is the SIF format, which is defined as part of the Cytoscape application \cite{Shannon2003cytoscape}.
