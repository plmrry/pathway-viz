...
Biological pathways are generally represented as weighted, directed graphs and in some cases include hyperedges and compound nodes.
...
A category of tasks inherent to a variety of work in bioinformatics is the identification of \textit{causal relationships} that exist between biomolecular entities.
...
\todo[inline]{More on Activation and Inhibition? Activation and inhibition vs upregulation and downregulation?}

\subsubsection{Task: Identify Cascading Effects, one-to-one}
\todo[inline]{todo, i.e. finding paths}
...
\todo[inline]{we could keep going, as in: ``cascading effects, entity-to-parent, one-to-many, directed''...}
