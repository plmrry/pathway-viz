...
\todo[inline, author=FMG]{The notion of data provenance  (which publications it comes form) was very important to researchers i have talked to. It clearly relates to uncertainty visualization here but also should be part of the attribute visualization task or form a task in its own right}
